...
class LiveDraftTool:
    ...
    def process_draft_data(self, html_content):
        ...
        players = soup.find_all('div', {'class': 'css-146c3p1 r-dnmrzs r-1udh08x r-1udbk01 r-3s2u2q r-1iln25a r-1khnkhu r-jnhe0o r-1enofrn r-1dpkw9 r-1cwl3u0 r-vmopo1'})
...
# Split picknums into two lists delimited by .
        ...
        df = pd.DataFrame({'Round': rounds, 'Pick': picks, 'OvrPick': overpicks, 'Team': teams, 'Pos': positions, 'Player': players, 'DraftedBy': fteams})
